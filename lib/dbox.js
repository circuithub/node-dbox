...
// Helpers
var exists = function(v) { return (typeof v !== "undefined" && v !== null); };
    ...
    client: function(options){
      ...
      return {
        ...
        get: function(path, args, cb){
          ...
          var requestArgs = {};
          var sigArgs = args;
          if (exists(args) && exists(args.range)) {
            requestArgs.headers = { Range: args.range };
            delete sigArgs.range;
          }

          var signature = helpers.sign(options, sigArgs)
          var url = helpers.url({
          ...
          requestArgs["url"] = url;
          requestArgs["encoding"] = null;
          
          return request(requestArgs, function(e, r, b) {
            if (e) {
               cb(null, null, null);
            } else {
